...
const allOptions = {
  ...
  nodes: {
    ...
    shape: { string: ['custom', 'ellipse', 'circle', 'database', 'box', 'text', 'image', 'circularImage', 'diamond', 'dot', 'star', 'triangle', 'triangleDown', 'square', 'icon', 'hexagon', 'toast'] },
...
const configureOptions = {
  nodes: {
    ...
    shape: ['ellipse', 'box', 'circle', 'database', 'diamond', 'dot', 'square', 'star', 'text', 'triangle', 'triangleDown','hexagon', 'toast'],
    shapeProperties: {
      borderDashes: false,
