...
class NavigationHandler {
  ...
  loadNavigationElements() {
    ...
    this.navigationDOM['navround'] = document.createElement('div');
    this.navigationDOM['navround'].className = 'vis-round-panel';
    this.navigationDOM['wrapper'].appendChild(this.navigationDOM['navround']);

    this.navigationDOM['navzoom'] = document.createElement('div');
    this.navigationDOM['navzoom'].className = 'vis-zoom-panel';
    this.navigationDOM['wrapper'].appendChild(this.navigationDOM['navzoom']);

    this.navigationDOM['toolbox'] = document.createElement('div');
    this.navigationDOM['toolbox'].className = 'vis-tool-box';
    this.navigationDOM['wrapper'].appendChild(this.navigationDOM['toolbox']);


    this.navigationDOM['dashboard'] = document.createElement('div');
    this.navigationDOM['dashboard'].className = 'center';
    this.navigationDOM['dashboard-span'] = document.createElement('span');
    this.navigationDOM['dashboard-span'].className = 'dash-menu';
    this.navigationDOM['dashboard-span-span'] = document.createElement('span');
    this.navigationDOM['dashboard-span-span'].className = 'config-menu-item';
    this.navigationDOM['dashboard-span-p'] = document.createElement('p');
    this.navigationDOM['dashboard-span-p'].className = 'config-menu-text';
    this.navigationDOM['dashboard-span-p'].innerHTML = 'dashboard';
    this.navigationDOM['dashboard-span'].appendChild(this.navigationDOM['dashboard-span-span']);
    this.navigationDOM['dashboard-span'].appendChild(this.navigationDOM['dashboard-span-p']);
    this.navigationDOM['dashboard'].appendChild(this.navigationDOM['dashboard-span']);
    this.navigationDOM['toolbox'].appendChild(this.navigationDOM['dashboard']);
    ...
    const dash_hammer = new Hammer(this.navigationDOM['dashboard']);
    onTouch(dash_hammer, this._toolConfig.bind(this))
    this.navigationHammers.push(dash_hammer);
  ...
  /**
  *
  * @private config button action
  */
  _toolConfig() {
    console.log('user click config control button.....');
  }
