...
import Toast from './nodes/shapes/Toast';
import Gate from './nodes/shapes/Gate';
    ...
    if (currentShape === this.options.shape && this.shape) {
      ...
      switch (this.options.shape) {
        ...
        case 'triangleDown':
          ...
          break;
        case 'toast':
          this.shape = new Toast(this.options, this.body, this.labelModule);
          break;
        case 'gate':
          this.shape = new Gate(this.options, this.body, this.labelModule);
